ifdef FD_HAS_HOSTED
ifdef FD_HAS_DOUBLE
$(call add-hdrs,fd_pack.h fd_pack_auction.h fd_est_tbl.h fd_compute_budget_program.h fd_microblock.h fd_pack_rebate_sum.h)
...
$(call make-unit-test,test_pack_auction,test_pack_auction,fd_disco fd_ballet fd_util)
...
$(call run-unit-test,test_pack_auction)
